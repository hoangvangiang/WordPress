...
This plugin is offered to you by iTx Technologies, [développement Web à Montréal](http://itx-technologies.com/)
...
= 1.4.3 =
* Fixed a bug where Google Webmaster Tools complained about a duplicate entry in the XML file

= 1.4.4 =
* Fixed a small bug

= 1.5.0 =
* Made sure the plugin is compatible with Wordpress 3.5.1